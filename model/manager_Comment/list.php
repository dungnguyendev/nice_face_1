...
$listBrands = thong_ke_comment();
?>
<section class="home" style="padding: 2rem 20rem; ">
    <h1 class="heading">Quản lý comment</h1> <br>
                ...
                <?php foreach ($listBrands as $row) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="./edit.php?id=<?= $row['id'] ?>" class="btn"><input type="button" value="Trả lời" style="background:#ff9a9a;"></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
