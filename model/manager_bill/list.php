...
$listBrands = quan_ly_bill();
?>
<section class="home" style="padding: 2rem 20rem; ">
    <h1 class="heading">Quản lý đơn hàng</h1> <br>
                ...
                <?php foreach ($listBrands as $row) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="./view_bill.php?id=<?= $row['id'] ?>" class="btn"><input type="button" value="view bill" style="background:#66CDAA;"></a>
